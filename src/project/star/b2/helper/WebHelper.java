...
public class WebHelper {
	...
	/** Multipart 전송 시 텍스트 데이터를 저장하기 위한 컬렉션 */
	 ...
	 * @param defaultValue - 값이 없을 경우 대체할 기본 값
	 * @return Object이므로 명시적 형변환 필요한
	 */
	...
	public String getJsonData(int statusCode, String rt, Map<String, Object> data) {
		...
		// HTTP 상태 코드 설정 (200, 404, 500등)
		this.response.setStatus(statusCode);

		// CrossDomain에 의한 접근 허용 (보안에 좋지 않기 때문에 이 옵션을 허용할 경우 인증키 등의 보안 장치가 필요함)
		// 여기서는 실습을 위해 허용함
	 ...
	 * 
	 * Service 구현체에서 예외 발생시 전달하는 에러 메시지등을 JSON으로 표현 할 때 사용.
	 * 
	 * @param rt
	 * 
	 * @return String
