...
<script>
      ...
      $("#insnumber").click(function() {
                  ...
                  $("#buttonjoin").click(function() {
                     ...
                     /** 이름 검사 */
                     if (!regex.value('#user_id', '이름을 입력하세요.')) {
                        return false;
                     }
                     if (!regex.kor('#user_id', '이름은 한글만 입력 가능합니다.')) {
                        return false;
                     }
                     ...
                     /** 이메일 검사 */
                     if (!regex.value('#email', '이메일를 입력하세요.')) {
                        return false;
                     }
                     if (!regex.value('#email1', '이메일도메인을 선택하세요.')) {
                        return false;
                     }
                     ...
                     if (!regex.value('#reemailinput', '인증번호를 입력하세요.')) {
                        return false;
                     }
                     var user = $('#reemailinput').val();
                     if (user != auth) {
                     ...
                     /** 휴대폰 검사 */
                     if (!regex.value('#tel1', '번호를 입력하세요.')) {
                        return false;
                     }
                     if (!regex.value('#tel2', '번호를 입력하세요.')) {
                        return false;
                     }
                     if (!regex.max_length('#tel1', 4, '번호는 4자 입력하세요.')) {
                        return false;
                     }
