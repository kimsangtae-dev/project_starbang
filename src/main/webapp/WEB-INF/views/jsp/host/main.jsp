...
<body>
	...
	<div id="root">
		...
		<div id="body">
			<div class="bgimg">
				<h1 class="title">
					공실 광고<img src="${pageContext.request.contextPath}/assets/assets_etc/ico/logo_white.png">에서 무제한 무료
				</h1>
...
=======
				<a class="link-sc" href="rm_add.do">방주인 시작하기</a>
>>>>>>> b2562550a70f489484caee7c3fc86ae9ec85aa4b
			</div>
		</div>
	</div>
	<!-- 하단 영역 -->
