...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/assets/css/ho_css/rm_add.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/plugin/datepicker/datepicker.min.css" />
							...
							<tbody>
								<tr>
									...
									<td class="bang_choice"><label class="Square_box"><input
											type="radio" name="roomtype" value="원룸" checked />
											<p>원룸</p> </label> <label class="Square_box"><input
											type="radio" name="roomtype" value="투룸" />
											<p>투룸</p> </label> <label class="Square_box"><input
											type="radio" name="roomtype" value="쓰리룸" />
											<p>쓰리룸</p> </label> <label class="Square_box"><input
											type="radio" class="ab" name="roomtype" value="오피스텔" />
											<p>오피스텔(도시형)</p> </label></td>
								</tr>
								<tr>
									<th>건물 유형</th>
									<td class="bang_choice"><label class="Square_box"><input
							...
							<tbody>
								<tr>
									...
									<td class="loc_box_pd">
										<div class="loc_box">
											<p class="loc_p_t">
												<span class="glyphicon glyphicon-exclamation-sign"></span> <span>도로명,
						...
						<table>
							<tbody>
								<tr>
									...
									<td class="base_line">
										<p class="base_title">건물 층수</p> <select class="floor1 hRFrgm"
					...
					<div class="tableframe" name="additional">
						...
						<table>
							<tbody>
								<tr>
									<th rowspan="2">관리비</th>
									<td class="add_info" colspan="3"><input type="text"
										id="main_pr_v1" id="fee" name="fee" class="add2 input_box"
										disabled>
										<p class="add3">만원</p>
										<div class="main">
											<label class="add_check_box" size="22"> <input
												type="checkbox" id="main_input" name="fee" value="0"
												class="PcMeW" checked> <span class="CheckBox"></span>
								...
								<tr>
									<td class="add_info" colspan="3">
										<div class="add_m">
											<p>관리비항목</p>
											<p>(다중선택가능)</p>
										</div> <label class="ma_box ma_m"> <input type="checkbox"
											id="user_input" class="user_input" name="feeitem" value="64">
											<p>인터넷</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox"
											class="user_input" name="feeitem" value="32">
											<p>유선TV</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox"
											class="user_input" name="feeitem" value="16">
											<p>청소비</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox"
											class="user_input" name="feeitem" value="8">
											<p>수도세</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox"
											class="user_input" name="feeitem" value="4">
											<p>도시가스</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox"
											class="user_input" name="feeitem" value="2">
											<p>전기세</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox"
											class="user_input" name="feeitem" value="1">
											<p>기타</p>
									</label>
									</td>
								</tr>
								<tr>
									<th>주차여부</th>
									<td class="add_info"><label class="add1 Square_box">
											<input type="radio" id="unparking" name="parking" value="-1"
											checked="">
											<p>불가능</p>
									</label> <label class="add1 Square_box"> <input type="radio"
											id="parkingok" name="parking" value="1">
											<p>가능</p>
									</label> <input type="text" id="parking" class="add2 input_box"
										name="parking_val" disabled>
										<p class="add3">만원</p></td>

									<th>반려동물</th>
									<td class="add_info"><label class="add1 Square_box"><input
											type="radio" name="pet" value="1" checked="">
											<p>가능</p> </label> <label class="add1 Square_box"><input
											type="radio" name="pet" value="0">
											<p>불가능</p> </label></td>
								</tr>
								<tr>
									<th>엘리베이터</th>
								...
								<tr>
									<th>빌트인</th>
									<td class="add_info" colspan="1"><label
										class="add1 Square_box"><input type="radio"
											name="builtin" value="0" checked="">
											<p>없음</p> </label> <label class="add1 Square_box"><input
											type="radio" name="builtin" value="1">
											<p>있음</p> </label></td>
								</tr>
								<tr>
									<th>옵션항목</th>
									...
									<label class="ma_box ma_m"> 
											...
											<p>에어컨</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox" name="optionitem" value="2048">
											<p>세탁기</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox" name="optionitem" value="1024">
											<p>침대</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox" name="optionitem" value="512">
											<p>책상</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox" name="optionitem" value="256">
											<p>옷장</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox" name="optionitem" value="128">
											<p>TV</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox" name="optionitem" value="64">
											<p>신발장</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox" name="optionitem" value="32">
											<p>냉장고</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox" name="optionitem" value="16">
											<p>가스레인지</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox" name="optionitem" value="8">
											<p>인덕션</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox" name="optionitem" value="4">
											<p>전자레인지</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox" name="optionitem" value="2">
											<p>전자도어락</p>
									</label> <label class="ma_box ma_m"> <input type="checkbox" name="optionitem" value="1">
											<p>비데</p>
									</label></td>
								</tr>
								<tr>
									<th>전세자금대출</th>
									<td class="add_info" colspan="3"><label
										class="add1 Square_box"><input type="radio"
											name="loan" value="0" checked="">
											<p>불가능</p> </label> <label class="add1 Square_box"><input
											type="radio" name="loan" value="1">
											<p>가능</p> </label></td>
								</tr>
							</tbody>
						</table>
...
* 다방의 매물등록 규정에 위반되는 금칙어는 등록이 불가합니다."></textarea>
						...
						<div class="photo_box">
							...
							<div class="photo_info">
								...
								<div class="filebox">
									...
									<label for="ex_file">사진등록</label> <input type="file"
										id="ex_file" accept=".jpg,.jpeg,.png" maxlength="15" />
								</div>
							</div>
							<p class="warning_text">
								<span class="glyphicon glyphicon-exclamation-sign"></span> <span>허위
									매물을 등록할 경우 다방에서 임의로 계정 및 매물 전체 삭제 처리됩니다.</span> <a href="#"
					...
					<!-- lowbox -->
					<div class="low_box">
						<label class="low_text low_check_box" size="22"> <input
							type="checkbox" class="PcMeW" id="isAgree" name="isAgree"
							value=""> <span class="CheckBox"></span> <span
							class="low_text1">매물관리규정을 확인하였으며, 입력한 정보는 실제 매물과 다름이 없습니다.</span>
						</label>
