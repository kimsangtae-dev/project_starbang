    ...
    <body>
        <div id="root">
            <div class="box">
                ...
                <!-- header 끝 -->
                <!-- content 시작 -->
                    <div id="content"> <form id="add_room" action="${pageContext.request.contextPath}/host">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="deal_box_pd">
                                            ...
                                            <div class="short">
                                                <label class="deal_check_box" size="22"><input type="checkbox" class="PcMeW" name="short_room" value=""><span class="CheckBox"></span>
                ...
                <div class="tableframe" name="additional">
                    ...
                    <table>
                        <tbody>
                            <tr>
                                <th rowspan="2">관리비</th>
                                <td class="add_info" colspan="3"><input type="text" id="main_pr_v1" id="fee" name="fee" class="add2 input_box" disabled>
                                    <p class="add3">만원</p>
                                    <div class="main">
                            ...
                            <tr>
                                ...
                                <td class="add_info">
                                    ...
                                    <label class="add1 Square_box">
                                        <input type="radio" id="parkingok" name="parking" value="1">
                                        <p>가능</p>
                                    </label>
                            ...
                            <tr>
                                ...
                                <td class="add_info" colspan="1">
                                    <label class="add1 Square_box"><input type="radio" name="builtin" value="0" checked="">
                                        <p>없음</p>
                                    </label>
                                    <label class="add1 Square_box"><input type="radio" name="builtin" value="1">
                                        <p>있음</p>
                                    </label>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th>전세자금대출</th>
                                <td class="add_info" colspan="3">
                                    <label class="add1 Square_box"><input type="radio" name="loan" value="0" checked="">
                                        <p>불가능</p>
                                    </label>
                                    <label class="add1 Square_box"><input type="radio" name="loan" value="1">
                                        <p>가능</p>
                                    </label>
                                </td>
                            </tr>
                ...
                <div class="tableframe" name="detailInfo">
                    ...
                    <table>
                        <tbody>
                            <tr>
                                <th>제목</th>
                                <td class="detail_box"><input type="text" id="title" class="detail_box1 input_box" name="title" placeholder="예)신논현역 도보 5분거리, 혼자 살기 좋은 방 입니다."></td>
                            </tr>
                            <tr>
                                <th>상세 설명</th>
                                <td class="detail_box">
                                    <textarea class="detail_des" style="resize: none;" id="content_input" name="content" placeholder="※상세설명 작성 주의사항
...
* 다방의 매물등록 규정에 위반되는 금칙어는 등록이 불가합니다."></textarea>
                    ...
                    <div class="photo_box">
                        ...
                        <div class="photo_info">
                            ...
                            <div class="filebox">
                                ...
                                <input type="file" id="ex_file" accept=".jpg,.jpeg,.png" maxlength="15"/>
                            </div>
                        </div>
                        <p class="warning_text">
                            <span class="glyphicon glyphicon-exclamation-sign"></span>
                            <span>허위
                                									매물을 등록할 경우 다방에서 임의로 계정 및 매물 전체 삭제 처리됩니다.</span>
        ...
        <!-- footer 시작 -->
        <!-- 하단 영역 -->
            <div id="footer"> <%@ include file="../assets/inc/ho_footer.jsp"%>
        </div>
        <!-- footer 끝 -->
    </body>
</html></div><!-- box 끝 --></div><!-- root 끝 --><!-- Javascript --><script src="${pageContext.request.contextPath}/assets/js/jquery-3.2.1.min.js"></script><script src="//cdnjs.cloudflare.com/ajax/libs/jquery.form/4.2.2/jquery.form.min.js"></script><script src="${pageContext.request.contextPath}/assets/js/bootstrap.min.js"></script><script src="${pageContext.request.contextPath}/assets/js/regex.js"></script><!-- 카카오 지도 시작--><script src="https://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script><script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c2af26a361b5d6ffd94b478877c3ee14&libraries=services"></script><script>var mapContainer = document.getElementById('box'), // 지도를 표시할 div
    mapOption = {
...
}</script><!-- 카카오 지도 끝 --><!-- datepicker 시작 --><script src="${pageContext.request.contextPath}/assets/plugin/datepicker/datepicker.min.js"></script><script src="${pageContext.request.contextPath}/assets/plugin/datepicker/i18n/datepicker.ko-KR.js"></script><script>$(function () {
...
});</script><!-- datepicker 끝 --><!-- 동정보 위치이동 시작 --><script>/* 동정보 체크박스 -> 동 삭제 */
$(function () {
...
});</script><!-- 동정보 위치이동 끝 --><!-- 공급면적 평수 계산기 --><script>function calculator(chk) {
    if (chk == 1) {
...
}</script><!-- 평수 계산기 --><!-- 전용면적 평수 계산기 --><script>function ator(chk) {
    if (chk == 1) {
...
}</script><!-- 평수 계산기 끝--><script>$(function () { /* `#input_enable`의 선택 상태가 변경된 경우 */
...
});</script><script>// 오피스텔 선택시 자동선택
$(document).ready(function () {
    $('.ab').click(function () {
        $('.ab1').prop('checked', this.checked);
    });
});</script><script>// 관리비 fee
$("input#main_input").click(function () {
    if ($("input#main_input:checked").val()) { // 비활성화
...
$(".user_input").click(function () {
...
});</script><!-- 월세, 전세, 매매 버튼 활성화 --><script>$(function () { // 월세 버튼
    ...
    // 월세 버튼
    $(document).on("click", ".pp", function () { // 클릭된 버튼 상위요소인 `.item`찾아서 제거한다.
        $(this).parents('.d_div').remove();
    });
    // 전세 버튼
    $(document).on("click", ".pp1", function () { // 클릭된 버튼 상위요소인 `.item`찾아서 제거한다.
        $(this).parents('.d_div1').remove();
        $(".deal_btn1").removeAttr("disabled");
    });
    // 매매 버튼
    $(document).on("click", ".pp2", function () { // 클릭된 버튼 상위요소인 `.item`찾아서 제거한다.
...
/* function reflex(){
    ...
    $('.low_btn2').click(function () { /** 매물종류 검사 (1) */
        if (!regex.check("input[name='buildtype']:checked", '건물유형을 선택해주세요.')) {
            $("input[name='buildtype'").focus();
            return false;
        }
        // 건물유형 buildtype
        /** 
     * 주소 검사 (3) 
     */
        if (!regex.value('#point_address', '주소를 입력해주세요.')) {
            $("#point_address").focus();
            return false;
        } // 주소 address
        if ($("#is_noinfo_dong:checked").length == 0) {
            if (!regex.value('#dong', '동 주소를 입력해주세요.')) {
                return false;
            }
        } // 동 dong
        if (!regex.value('#ho', '호 주소를 입력해주세요.')) {
            $("#ho").focus();
            return false;
        }
        // 호 ho
     ...
     */
        ...
        if (dealingtype.val()) {
            for (var i = 0; i < dealingtype.length; i++) {
                ...
                if (! deposit.eq(i).val()) {
                    alert(dealingtype.eq(i).val() + "의 보증금 액수를 입력해주세요.");
                    deposit.eq(i).focus();
                    return false;
                }
                if (! price.eq(i).val()) {
                    alert(dealingtype.eq(i).val() + "의 금액을 입력해주세요.");
                    price.eq(i).focus();
                    return false;
                }
            }
     ...
     */
        if (!regex.value('#pyeong1', '공급면적을 입력해주세요.')) {
            $("#pyeong1").focus();
            return false;
        } // 공급면적 supplyarea
        if (!regex.value('#ator1', '전용면적을 입력해주세요.')) {
            $("#pyeong2").focus();
            return false;
        }
        // 전용면적 area
        ...
        if (!regex.value('#maxfloor', '전체 층수를 입력해주세요.')) {
            $("#maxfloor").focus();
            return false;
        } // 전체층수
        if (!regex.value('#floor', '해당 층수를 입력해주세요.')) {
            $("#floor").focus();
            return false;
        }
        // 해당층수
        /** 층수 < 건물층수 설정 */
        if ($("#floor").val() > $("#maxfloor").val()) {
            alert("해당층수는 건물층수 보다 높을 수 없습니다.");
            $("#floor").focus();
            return false;
        }
        if (!regex.value('#heater', '난방 종류를 입력해주세요.')) {
            $("#heater").focus();
            return false;
        } // 난방종류
        ...
        if (check.length == 0) {
            if (!regex.value('#main_pr_v1', '관리비 금액을 입력해주세요.')) {
                $("#main_pr_v1").focus();
                return false;
            } // 관리비 금액
        }
        ...
        if (check.length > 0) {
            if (!regex.value('#parking', '주차비 금액을 입력해주세요.')) {
                $("#parking").focus();
                return false;
            }
        } // 주차비
        if (!regex.value('#title', '제목을 입력해주세요.')) {
            $("#title").focus();
            return false;
        } // 제목
        if (!regex.value('#content_input', '상세설명을 입력해주세요.')) {
            $("#content_input").focus();
            return false;
        } // 해당층수
        if (!regex.check('#isAgree', '매물관리 규정에 동의해주세요.')) {
            $("#isAgree").focus();
            return false;
        }
        // #addForm에 대한 submit이벤트를 가로채서 Ajax요청을 전송한다.
        $("#add_room").ajaxForm({ // 전송 메서드 지정
            method: "POST",
