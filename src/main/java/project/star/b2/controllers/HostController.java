...
public class HostController {
	...
	public ModelAndView rm_add_ok(Model model) {
		...
		// 어드레스 input.setAddress(address);
		input.setDong(dong);
		input.setHo(ho);
		// 위도 y input.setLatitude(latitude);
		// 경도 x input.setLongitude(longitude);
		// 동 input.setRegion_2depth_name(region_2depth_name);
		// 호 input.setRegion_3depth_name(region_3depth_name);
