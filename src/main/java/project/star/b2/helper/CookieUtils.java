...
public class CookieUtils {
     ...
     */
    public static void setYummy(String key, String value, int day, HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
