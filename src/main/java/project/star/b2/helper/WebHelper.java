    ...
    public void upload() throws Exception {
        ...
        for (FileItem f : items) {
            if (f.isFormField()) {
                ...
                String regDate = String.format("%04d-%02d-%02d", c.get(Calendar.YEAR), c.get(Calendar.MONTH) + 1, c.get(Calendar.DAY_OF_MONTH));
                String editDate = String.format("%04d-%02d-%02d", c.get(Calendar.YEAR), c.get(Calendar.MONTH) + 1, c.get(Calendar.DAY_OF_MONTH)); // 변경일자
    ...
    public void profileUpload() throws Exception {
        ...
        for (FileItem f : items) {
            if (f.isFormField()) {
                ...
                Calendar c = Calendar.getInstance();
                c.add(Calendar.DAY_OF_MONTH, -1);
                // String regDate = String.format("%04d-%02d-%02d", c.get(Calendar.YEAR),
