...
<body>
	...
	<div id="ad_main">
		...
		<div id="content">
			<div class="box1">
				<!--부트스트랩 버튼 요소 적용-->
				<a class="btn btn-primary btn-lg" href="#" role="button">방관리</a>
				<a class="btn btn-primary btn-lg" href="#" role="button">회원관리</a>
				<!-- 부트스트랩 드롭다운 요소 적용을 위한 선언-->
				<div class="dropdown">
						<a id="dLabel" data-target="#" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false"><span >문의관리
