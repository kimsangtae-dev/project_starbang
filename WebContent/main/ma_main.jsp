...
<%@ include file="./ma_assets/ma_inc/top.jsp"%>
        ...
        <div class="slide-div1">
          <div class="slide-div2">
            <div class="slide-div3 slider regular" style="right: 0px;">
              ...
              <div>
                <a class="slide-a" href="ma_rmdt.jsp">
        ...
        <div class="pop-gallery-d"> 
          ...
          <div class="each-d1">
            <div class="each-d2">
              ...
              <!-- 전체 링크화 -->
              <a target="_blank" rel="" class="gallery-a" href="ma_rmdt.jsp">
                <!-- 이미지 -->
    ...
    <div class="recent">
      <div class="recent-div0">
        <div class="recent-div1"><a href="ma_rtrm.jsp">김기홍님의 최근 본 방</a></div>
        <div class="recent-div2"><a href="ma_wish.jsp">찜한 방</a></div>
