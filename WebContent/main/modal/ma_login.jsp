...
<head>
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/main/ma_assets/modal_css/ma_login.css">
</head>
                	...
                	<div class="login" id="">
                	    <form class="">
                	        ...
                	        <div class="checkbox-d">
                	            ...
                	            <!-- 비밀번호 찾기 -->
                	            <a href="<%=request.getContextPath()%>/main/modal/ma_pwd.jsp" data-dismiss="modal" 
                	    ...
                	    <div class="joinus-div">
                	        <p>아직 회원이 아니세요?
                	            <a href="<%=request.getContextPath()%>/main/modal/ma_agree.jsp" id="join" data-dismiss="modal" data-toggle="modal" data-target="#agreeModal">이메일로 회원가입</a>
                	        </p>
                	    </div>   
                	</div>
                </div>
