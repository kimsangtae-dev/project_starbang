	...
	<div id="root">
		...
		<div id="content">
			<div class="sell_room_box">
				...
				<ul class="sell_tab">
					<li><a class="active" aria-current="page" href="#">방 내놓기</a></li>
			...
			<div class="styled__Box-sc-1etgh1k-1 tableframe1" name="roomType">
				...
				<table>
					...
					<tbody>
						<tr>
							<th>종류 선택</th>
							<td class="styled__Td-loqpne-0 fNOtpc"><label
								class="styled__Radio-loqpne-1 bVNPCb styled__RadioBtn-j1kyvo-0 fSFsCh"><input
									type="radio" name="room_type" checked="">
								<p>원룸</p> </label> <label
								class="styled__Radio-loqpne-1 bVNPCb styled__RadioBtn-j1kyvo-0 fSFsCh"><input
						...
						<tr>
							...
							<td class="styled__Td-loqpne-0 fNOtpc"><label
								class="styled__Radio-loqpne-1 bVNPCb styled__RadioBtn-j1kyvo-0 fSFsCh"><input
									type="radio" name="building_type">
								<p>단독주택</p> </label> <label
								class="styled__Radio-loqpne-1 bVNPCb styled__RadioBtn-j1kyvo-0 fSFsCh"><input
									type="radio" name="building_type">
								<p>다가구주택</p> </label> <label
								class="styled__Radio-loqpne-1 bVNPCb styled__RadioBtn-j1kyvo-0 fSFsCh"><input
									type="radio" name="building_type">
								<p>빌라/연립/다세대</p> </label> <label
								class="styled__Radio-loqpne-1 bVNPCb styled__RadioBtn-j1kyvo-0 fSFsCh"><input
									type="radio" name="building_type">
								<p>상가주택</p> </label></td>
						</tr>
						...
						<tr>
							...
							<td class="styled__Td-sc-1wmqs5y-0 loc_t">
								<div class="styled__Wrap-sc-1wmqs5y-1 loc_in_box">
									...
									<form class="styled__Form-sc-1wmqs5y-3 loc_search">
										<input autocomplete="off"
											class="styled__Keyword-sc-1wmqs5y-4 loc_search1 Input-sfsekm-0 loc_search2"
											name="keyword" placeholder="예)번동 10-1, 강북구 번동" value="">
										<button type="submit"
											class="styled__SearchBtn-sc-1wmqs5y-5 loc_btn">주소검색</button>
									</form>
									<div class="styled__Address-sc-1wmqs5y-6 loc_detail"></div>
									<div class="styled__Detail-sc-1wmqs5y-7 address">
										<div
											class="styled__DongBox-sc-1wmqs5y-9 jlsyRm styled__Box-sc-1wmqs5y-8 dong">
											<input autocomplete="off"
												class="styled__Dong-sc-1wmqs5y-10 bVCGUR Input-sfsekm-0 loc_search2"
												name="dong" placeholder="예)101동" value="">
										</div>
										<div
											class="styled__HoBox-sc-1wmqs5y-11 dong1 styled__Box-sc-1wmqs5y-8 dong">
											<input autocomplete="off"
												class="styled__Ho-sc-1wmqs5y-12 gVtYYG Input-sfsekm-0 loc_search2"
												name="ho" placeholder="예)201호" value="">
										</div>
									</div>
									<div class="styled__CheckWrap-sc-1wmqs5y-13 gZWbGn">
										<label class="clearfix Checkbox__Label-ifp1yz-0 kAqGVi"
											size="22"><input type="checkbox"
											class="Checkbox__CheckboxStd-ifp1yz-1 PcMeW"
											name="is_noinfo_dong" value=""><span class="CheckBox"></span>
											<span class="styled__CheckText-sc-1wmqs5y-14 kmXRUf">등본에
								...
								<div class="styled__Map-sc-1wmqs5y-15 kADOdT">
									<div class="styled__Pin-sc-1wmqs5y-16 dioXoB">
										<svg width="52" height="52" viewbox="0 0 52 52">
												...
												fill-rule="evenodd" transform="translate(1 1)">
                                                        <circle
												cx="25.2" cy="25.2" r="25.2" fill="#FFF" stroke="#EEE"
									...
									<p class="styled__MapDesc-sc-1wmqs5y-17 cOSEj">해당 위치가 지도에
										표시됩니다.</p>
								</div>
							</td>
						</tr>
							...
							<td class="styled__Td-sc-1toww6o-0 iFmBhb">
								...
								<div class="styled__CheckWrap-sc-1toww6o-2 fZAwwn">
									<label class="clearfix Checkbox__Label-ifp1yz-0 kAqGVi"
										size="22"><input type="checkbox"
										class="Checkbox__CheckboxStd-ifp1yz-1 PcMeW"
										name="short_lease" value=""><span class="CheckBox"></span>
					...
					<tbody>
						<tr>
							...
							<td class="styled__Td-sc-4u7gy5-0 ggZjqG">
								...
								<input autocomplete="off"
								class="styled__Size-sc-4u7gy5-4 gsCYXz Input-sfsekm-0 loc_search2"
								name="provision_size_pyeong" value="">
							<p class="styled__Space-sc-4u7gy5-6 cmXpqK">평</p>
								<input autocomplete="off"
								class="styled__Size-sc-4u7gy5-4 gsCYXz Input-sfsekm-0 loc_search2"
								name="provision_size" value="">
							<p class="styled__Space-sc-4u7gy5-6 cmXpqK">㎡</p>
							</td>
							<th rowspan="2">건물 층수</th>
							<td class="styled__Td-sc-4u7gy5-0 ggZjqG">
								<p class="styled__SubTitle-sc-4u7gy5-3 hNdXGi">건물 층수</p> <select
								class="styled__Floor-sc-4u7gy5-7 freEbZ Select-sc-1sy32zq-0 hRFrgm"
								name="building_floor">
						...
						<tr>
							<td class="styled__Td-sc-4u7gy5-0 ggZjqG">
								...
								<input autocomplete="off"
								class="styled__Size-sc-4u7gy5-4 gsCYXz Input-sfsekm-0 loc_search2"
								name="room_size_pyeong" value="">
							<p class="styled__Space-sc-4u7gy5-6 cmXpqK">평</p>
								<input autocomplete="off"
								class="styled__Size-sc-4u7gy5-4 gsCYXz Input-sfsekm-0 loc_search2"
								name="room_size" value="">
							<p class="styled__Space-sc-4u7gy5-6 cmXpqK">㎡</p>
							</td>
							<td class="styled__Td-sc-4u7gy5-0 ggZjqG">
								<p class="styled__SubTitle-sc-4u7gy5-3 hNdXGi">해당 층수</p> <select
								class="styled__Floor-sc-4u7gy5-7 freEbZ Select-sc-1sy32zq-0 hRFrgm"
								name="room_floor">
						...
						<tr>
							<th>난방 종류</th>
							<td class="styled__Td-sc-4u7gy5-0 ggZjqG" colspan="3"><select
								class="styled__Heating-sc-4u7gy5-8 iDUqOA Select-sc-1sy32zq-0 hRFrgm"
								name="heating_type">
						...
						<tr>
							...
							<td class="styled__Td-sc-4u7gy5-0 ggZjqG" colspan="3">
								<button class="styled__MoveDate-sc-4u7gy5-10 zxfCA">즉시
									입주</button>
								<button class="styled__MoveDate-sc-4u7gy5-10 zxfCA">날짜
									협의</button>
								<button class="styled__MoveDate-sc-4u7gy5-10 zxfCA">날짜
									선택</button>
							</td>
			...
			<div class="styled__Box-sc-1etgh1k-1 tableframe" name="additional">
				...
				<table>
					...
					<tbody>
						<tr>
							<th rowspan="2">관리비</th>
							<td class="styled__Td-sc-1u6ustj-0 cCUCai" colspan="3"><label
								class="styled__Radio-sc-1u6ustj-1 gBFyOc styled__RadioBtn-j1kyvo-0 fSFsCh"><input
									type="radio" name="maintenance" checked="">
								<p>없음</p> </label> <label
								class="styled__Radio-sc-1u6ustj-1 gBFyOc styled__RadioBtn-j1kyvo-0 fSFsCh"><input
									type="radio" name="maintenance">
								<p>있음</p> </label><input autocomplete="off"
								class="styled__Cost-sc-1u6ustj-2 esuiyZ Input-sfsekm-0 loc_search2"
								type="text" name="maintenance_cost" disabled="" value="">
							<p class="styled__Space-sc-1u6ustj-3 iOAqhO">만원</p></td>
						</tr>
						<tr>
							<td class="styled__Td-sc-1u6ustj-0 cCUCai" colspan="3">
								...
								class="styled__Option-sc-1u6ustj-6 hrokF styled__CheckboxBtn-j1kyvo-1 cdcjQK"><input
									type="checkbox" name="maintenance_items">
								<p>인터넷</p> </label> <label
								class="styled__Option-sc-1u6ustj-6 hrokF styled__CheckboxBtn-j1kyvo-1 cdcjQK"><input
									type="checkbox" name="maintenance_items">
								<p>유선TV</p> </label> <label
								class="styled__Option-sc-1u6ustj-6 hrokF styled__CheckboxBtn-j1kyvo-1 cdcjQK"><input
									type="checkbox" name="maintenance_items">
								<p>청소비</p> </label> <label
								class="styled__Option-sc-1u6ustj-6 hrokF styled__CheckboxBtn-j1kyvo-1 cdcjQK"><input
						...
						<tr>
							<th>주차여부</th>
							<td class="styled__Td-sc-1u6ustj-0 cCUCai"><label
								class="styled__Radio-sc-1u6ustj-1 gBFyOc styled__RadioBtn-j1kyvo-0 fSFsCh"><input
									type="radio" name="parking" checked="">
								<p>불가능</p> </label> <label
								class="styled__Radio-sc-1u6ustj-1 gBFyOc styled__RadioBtn-j1kyvo-0 fSFsCh"><input
									type="radio" name="parking">
								<p>가능</p> </label><input autocomplete="off"
								class="styled__Cost-sc-1u6ustj-2 esuiyZ Input-sfsekm-0 loc_search2"
								type="text" name="parking_cost" disabled="" value="">
							<p class="styled__Space-sc-1u6ustj-3 iOAqhO">만원</p></td>
							<th>반려동물</th>
							<td class="styled__Td-sc-1u6ustj-0 cCUCai"><label
								class="styled__Radio-sc-1u6ustj-1 gBFyOc styled__RadioBtn-j1kyvo-0 fSFsCh"><input
						...
						<tr>
							...
							<td class="styled__Td-sc-1u6ustj-0 cCUCai" colspan="1"><label
								class="styled__Radio-sc-1u6ustj-1 gBFyOc styled__RadioBtn-j1kyvo-0 fSFsCh"><input
									type="radio" name="built_in" checked="">
								<p>없음</p> </label> <label
								class="styled__Radio-sc-1u6ustj-1 gBFyOc styled__RadioBtn-j1kyvo-0 fSFsCh"><input
									type="radio" name="built_in">
								<p>있음</p> </label></td>
							<th>구조</th>
							<td class="styled__Td-sc-1u6ustj-0 cCUCai"><label
								class="styled__Checkbox-sc-1u6ustj-4 fyqlMy styled__CheckboxBtn-j1kyvo-1 cdcjQK"><input
									type="checkbox" name="duplex">
								<p>복층</p> </label> <label
								class="styled__Checkbox-sc-1u6ustj-4 fyqlMy styled__CheckboxBtn-j1kyvo-1 cdcjQK"><input
									type="checkbox" name="division">
								<p>1.5룸/주방분리형</p> </label></td>
						</tr>
						<tr>
							<th>옵션항목</th>
							<td class="styled__Td-sc-1u6ustj-0 cCUCai" colspan="3"><label
			...
			<div class="styled__Box-sc-1etgh1k-1 tableframe" name="detailInfo">
				...
				<table>
					...
					<tbody>
						<tr>
							<th>제목</th>
							<td class="styled__Td-sc-1tnvlzf-0 iXeisV"><input
								autocomplete="off"
								class="styled__Title-sc-1tnvlzf-1 cNKZeV Input-sfsekm-0 loc_search2"
								type="text" name="title"
								placeholder="예)신논현역 도보 5분거리, 혼자 살기 좋은 방 입니다." value=""></td>
						</tr>
						<tr>
							<th>상세 설명</th>
							<td class="styled__Td-sc-1tnvlzf-0 iXeisV"><textarea
									class="styled__Memo-sc-1tnvlzf-2 iePFTd Textarea-sc-6jro6l-0 hunnDM"
									name="memo"
						...
						<tr>
							<th>비공개 메모</th>
							<td class="styled__Td-sc-1tnvlzf-0 iXeisV"><textarea
									class="styled__Private-sc-1tnvlzf-3 fAiWMO Textarea-sc-6jro6l-0 hunnDM"
									name="private_memo"
					...
					<div class="styled__PhotoWrap-sc-1tford7-1 photo_pick">
						...
						<div class="styled__DefaultView-sc-1tford7-3 phto_pic2">
							<svg width="70" height="70" viewbox="0 0 70 70">
									...
									fill-rule="evenodd">
                                            <circle cx="35" cy="35"
									r="35" fill="#D8D8D8"></circle>
                                            <g
									transform="translate(19 23)">
                                                <rect width="30"
									height="22" x="1" y="1" stroke="#777" stroke-width="2" rx="3"></rect>
                                                <circle cx="25" cy="7"
									r="2" fill="#777"></circle>
                                                <path fill="#777"
							...
							<p class="styled__Text-sc-1tford7-4 sBZgE">실 사진 최소 3장 이상 등록
								하셔야 하며, 가로 사진을 권장합니다.</p>
							<p class="styled__WarningText-sc-1tford7-5 red_font">다방 로고를
								제외한 불필요한 정보(워터마크, 상호, 전화번호 등)가 있는 매물은 비공개 처리 됩니다.</p>
						</div>
						<div class="styled__UploadWrap-sc-1tford7-6 pic_btn"
							style="position: relative;">
							<button class="styled__UploadBtn-sc-1tford7-7 pic_btn1"
								id="uploadPhoto" style="position: relative; z-index: 1;">일반
								사진 등록</button>
							<div id="html5_1dnp8j1nlkns1h7g6qk1pnk1mlt4_container"
								class="moxie-shim moxie-shim-html5"
								style="position: absolute; top: 0px; left: 498px; width: 124px; height: 40px; overflow: hidden; z-index: 0;">
								<input id="html5_1dnp8j1nlkns1h7g6qk1pnk1mlt4" type="file"
			...
			<div class="styled__AgreeWrap-sc-1etgh1k-2 low_box">
				<label class="clearfix Checkbox__Label-ifp1yz-0 low_text" size="22"><input
					type="checkbox" class="Checkbox__CheckboxStd-ifp1yz-1 PcMeW"
					name="isAgree" value=""><span class="CheckBox"></span> <span
					class="styled__AgreeText-sc-1etgh1k-3 low_text1">매물관리규정을
						확인하였으며, 입력한 정보는 실제 매물과 다름이 없습니다.</span> </label>
